...
Annotations = r'/home/nick/Desktop/HRRSD/Annotations/'
JPEG = r'/home/nick/Desktop/HRRSD/JPEGImages/'
classespath = r'/home/nick/Desktop/HRRSD/classes1/'


classes = ['airplane','baseball diamond', 'basketball court', 'bridge',
            'crossroad', 'ground track field', 'harbor', 'parking lot',
            'ship', 'storage tank', 'tennis court', 'T junction', 'vehicle']
